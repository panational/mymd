		...
		exports.fn.changeDialog = function(raw_url, init) {
            ...
            if (editor.find("." + dialogName).length < 1)
            {
                ...
                var dialogContent = ("<div class=\"" + classPrefix + "form\">" ) +
                                        ...
                                        "<br/>" +
                                        "<label>一级分类</label>" +
                                        "<input type=\"text\" style=\"height: 33px\" value=\"" + selection + "\" data-cat1 />" +
                                        "<br/>" +
                                        "<label>二级分类</label>" +
                                        "<input type=\"text\" style=\"height: 33px\" value=\"" + selection + "\" data-cat2 />" +
                                        "<br/>" +
                                        "<label>三级分类</label>" +
                                        "<input type=\"text\" style=\"height: 33px\" value=\"" + selection + "\" data-cat3 />" +
                                        "<br/>" +
                                        "<label>标签</label>" +
                ...
                dialog = this.createDialog({
                    ...
                    buttons : {
                        enter : ['保存', function() {
                            ...
                            var cat  = this.find("[data-cat1]").val()+ "," + this.find("[data-cat2]").val() + "," + this.find("[data-cat3]").val();
			...
			dialog.find("[data-cat1]").val(init.cat);
			dialog.find("[data-cat2]").val(init.cat);
			dialog.find("[data-cat3]").val(init.cat);
